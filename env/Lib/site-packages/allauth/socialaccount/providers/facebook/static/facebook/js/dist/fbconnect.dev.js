...
(function () {
  ...
  allauth.facebook = {
    ...
    login: function login(nextUrl, action, process, scope) {
      var self = this;
    ...
    onLoginCanceled: function onLoginCanceled()
    /* response */
    {
    ...
    onLoginSuccess: function onLoginSuccess(response, nextUrl, process) {
      var data = {
        next: nextUrl || '',
        process: process,
    ...
    logout: function logout(nextUrl) {
      var self = this;
    ...
    onLogoutSuccess: function onLogoutSuccess(response, nextUrl) {
      var data = {
        next: nextUrl || '',
        csrfmiddlewaretoken: this.opts.csrfToken
      };
